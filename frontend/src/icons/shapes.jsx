...
export function Triangle() {
  return (
    <svg
      ...
      fill='#e8eaed'
    >
      <path d='M134-160q-18 0-26.5-15.5T109-206l347-553q9-14 25-14t25 14l345 553q9 15 1 30.5T826-160H134Z' />
    </svg>
  )
}
...
export function Square() {
  return (
    ...
    >
      ...
      <g>
        <path d='M15.5,17h-11C3.67,17,3,16.33,3,15.5v-11C3,3.67,3.67,3,4.5,3h11C16.33,3,17,3.67,17,4.5v11C17,16.33,16.33,17,15.5,17z' />
      </g>
    </svg>
  )
}
